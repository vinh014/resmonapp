<div id="<?php echo $_bookingId; ?>" class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all display-booking-<?php echo $_bookingDisplay; ?>">
    <div class="portlet-header ui-widget-header ui-corner-all">
        <span class="ui-icon ui-icon-arrow-4 sortable-handle" title="<?php echo Lang::read('sortable_handle'); ?>"></span>
        <span class="ui-icon ui-icon-cancel display-booking-action" title="<?php echo Lang::read('display_booking'); ?>"></span>
